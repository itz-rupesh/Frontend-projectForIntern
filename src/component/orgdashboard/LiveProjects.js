...
const LiveProjects = () => {
    ...
    const addLiveProject = (e) => {
        ...
        axios.post(`${BASE_URL}/org/newpost`, project, { withCredentials: true })
            .then((res) => {
    ...
    const addToPastProject = (id) => {
        axios.post(`${BASE_URL}/org/archive`, {
            _id: id
    ...
    useEffect(() => {
        axios.get(`${BASE_URL}/org/info/liveprojects`, { withCredentials: true })
            .then((res) => {
