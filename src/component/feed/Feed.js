...
const Feed = () => {
    ...
    useEffect(() => {
        axios.get(`${BASE_URL}/account/feed/liveprojects`, { withCredentials: true })
            .then((res) => {
    ...
    const Swiped = (direction, index, _id, k) => {
        ...
        if (direction === "right") {
            axios.post(`${BASE_URL}/account/feed/liveprojects/rightswipe`, {
                project_id: _id
        ...
        if (direction === "left") {
            axios.post(`${BASE_URL}/account/feed/liveprojects/leftswipe`, {
                project_id: _id
            }, { withCredentials: true }).then((res) => {
                cogoToast.success(res.data.message);
            }).catch((err) => {
