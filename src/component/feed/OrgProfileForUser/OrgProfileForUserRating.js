...
const OrgProfileForUserRating = () => {
    ...
    const saveRating = (e) => {
        ...
        axios.post(`${BASE_URL}/account/feed/orgprofile/addrating/${org__id}`, ratingObject, { withCredentials: true })
            .then((res) => {
    ...
    useEffect(() => {
        ...
        axios.get(`${BASE_URL}/account/feed/orgprofile/rating/${org__id}`, { withCredentials: true })
            .then((res) => {
