...
const DashBoard = () => {
    ...
    const showDashBoard = async () => {
        axios.get(`${BASE_URL}/account/verify`, { withCredentials: true })
            .then((res) => {
        ...
        axios.get(`${BASE_URL}/account/info/basic`, { withCredentials: true })
            .then((res) => {
    ...
    const fileUploader = (e) => {
        ...
        axios.post(`${BASE_URL}/document/user/uploader`, formData, { withCredentials: true }).then((res) => {
            // console.log(res.data.url);
            axios.post(`${BASE_URL}/account/updateimage`, { url: res.data.url }, { withCredentials: true }).then((result) => {
