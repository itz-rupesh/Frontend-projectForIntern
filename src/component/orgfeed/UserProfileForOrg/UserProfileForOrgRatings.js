...
const UserProfileForOrgRating = () => {
    ...
    const uploadCertificate = (e) => {
        ...
        axios.post(`${BASE_URL}/document/org/uploader`, formData, { withCredentials: true }).then((res) => {
    ...
    useEffect(() => {
        ...
        axios.get(`${BASE_URL}/org/feed/userprofile/rating/${current_user_id}`, { withCredentials: true })
            .then((res) => {
    ...
    const saveRating = () => {
        ...
        axios.post(`${BASE_URL}/org/feed/userprofile/addrating/${current_user_id}`, { newRating }, { withCredentials: true })
            .then((res) => {
                cogoToast.success(res.data.message);
